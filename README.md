...
Сокращённое имя в описании узнаётся по вхождению, но только если совпадение
единственное; один порт соседа достаётся одному линку — второму нашему порту
с тем же описанием (обычно это члены одного агрегата) связь запишется без
порта, а не вторым владельцем чужого Po1.
...
Ожидаемый вывод: `Ran 122 tests ... OK`.
