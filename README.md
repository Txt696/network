...
строка на порт. Выбрали порт (или сразу несколько, мышью с Shift) и задали
внизу: режим access/trunk, VLAN, соседа и его порт. Настроенные порты
подсвечены, флажок «Только настроенные» прячет пустые — на 48 портах это
удобнее, чем листать весь список.
...
Ожидаемый вывод: `Ran 85 tests ... OK`.
